...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sel4_1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sel4_1.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sel4_1 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/AddressSpace.o: AddressSpace.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AddressSpace.o AddressSpace.cpp
...
${OBJECTDIR}/ProcessingUnit.o: ProcessingUnit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessingUnit.o ProcessingUnit.cpp
...
${OBJECTDIR}/SystemCall_IF.o: SystemCall_IF.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SystemCall_IF.o SystemCall_IF.cpp
...
${OBJECTDIR}/ThreadMap.o: ThreadMap.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreadMap.o ThreadMap.cpp

${OBJECTDIR}/UserApp.o: UserApp.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserApp.o UserApp.cpp

${OBJECTDIR}/VirtualRegister.o: VirtualRegister.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VirtualRegister.o VirtualRegister.cpp

${OBJECTDIR}/WaitingThreadSet.o: WaitingThreadSet.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WaitingThreadSet.o WaitingThreadSet.cpp
...
${TESTDIR}/tests/UserApp1testclass.o: tests/UserApp1testclass.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UserApp1testclass.o tests/UserApp1testclass.cpp


${TESTDIR}/tests/UserApp1testrunner.o: tests/UserApp1testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/UserApp1testrunner.o tests/UserApp1testrunner.cpp
...
${OBJECTDIR}/AddressSpace_nomain.o: ${OBJECTDIR}/AddressSpace.o AddressSpace.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AddressSpace_nomain.o AddressSpace.cpp;\
	else  \
...
${OBJECTDIR}/Log_nomain.o: ${OBJECTDIR}/Log.o Log.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Log_nomain.o Log.cpp;\
	else  \
...
${OBJECTDIR}/ProcessingUnit_nomain.o: ${OBJECTDIR}/ProcessingUnit.o ProcessingUnit.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ProcessingUnit_nomain.o ProcessingUnit.cpp;\
	else  \
...
${OBJECTDIR}/ReadyQueue_nomain.o: ${OBJECTDIR}/ReadyQueue.o ReadyQueue.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ReadyQueue_nomain.o ReadyQueue.cpp;\
	else  \
...
${OBJECTDIR}/SystemCall_IF_nomain.o: ${OBJECTDIR}/SystemCall_IF.o SystemCall_IF.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SystemCall_IF_nomain.o SystemCall_IF.cpp;\
	else  \
...
${OBJECTDIR}/ThreadMap_nomain.o: ${OBJECTDIR}/ThreadMap.o ThreadMap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ThreadMap_nomain.o ThreadMap.cpp;\
	else  \
...
${OBJECTDIR}/UserApp_nomain.o: ${OBJECTDIR}/UserApp.o UserApp.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/UserApp_nomain.o UserApp.cpp;\
	else  \
...
${OBJECTDIR}/VirtualRegister_nomain.o: ${OBJECTDIR}/VirtualRegister.o VirtualRegister.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VirtualRegister_nomain.o VirtualRegister.cpp;\
	else  \
...
${OBJECTDIR}/WaitingThreadSet_nomain.o: ${OBJECTDIR}/WaitingThreadSet.o WaitingThreadSet.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WaitingThreadSet_nomain.o WaitingThreadSet.cpp;\
	else  \
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/sel4_1.exe
